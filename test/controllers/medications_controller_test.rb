...
class MedicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medication" do
    assert_difference("Medication.count") do
      post medications_url, params: { medication: { name: @medication.name, skincare_resume_id: @medication.skincare_resume_id, started_on: @medication.started_on } }
    end
  ...
  test "should update medication" do
    patch medication_url(@medication), params: { medication: { name: @medication.name, skincare_resume_id: @medication.skincare_resume_id, started_on: @medication.started_on } }
