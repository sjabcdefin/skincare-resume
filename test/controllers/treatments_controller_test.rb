...
class TreatmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create treatment' do
    assert_difference('Treatment.count') do
      post treatments_url, params: { treatment: { description: @treatment.description, treated_on: @treatment.treated_on } }
    end
  ...
  test 'should update treatment' do
    patch treatment_url(@treatment), params: { treatment: { description: @treatment.description, treated_on: @treatment.treated_on } }
